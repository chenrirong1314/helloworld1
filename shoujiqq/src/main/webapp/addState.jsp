...
<body>
<div class="head-div">
			<span><a href="kojian.jsp">取消</a></span>
			<span><b>说说</b></span> 
			<button class="publish btn btn-default" >发表</button>
		</div>
		<div class="body-div">
			...
			<div>
				...
				<input style="display: none;" type="file" multiple name="file"/>
			</div>
		</div>
